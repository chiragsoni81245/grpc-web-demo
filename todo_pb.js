 ...
 * @const
 */
proto.todoPackage.TodoItems.repeatedFields_ = [2];
 ...
 * @return {number}
 */
proto.todoPackage.TodoItems.prototype.getTotalitems = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.todoPackage.TodoItems.prototype.setTotalitems = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
...
proto.todoPackage.TodoItems.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.todoPackage.TodoItem>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.todoPackage.TodoItem, 2));
};
...
proto.todoPackage.TodoItems.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.todoPackage.TodoItem, opt_index);
};
